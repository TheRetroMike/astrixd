...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/astrix-network/astrixd/database)

Package database provides a database for astrixd.
...
DataAccessor
------------
This defines the common interface by which data gets accessed in a generic astrixd
...
Transaction
-----------
This defines the interface of a generic astrixd database transaction.
