...
import (
	...
	"github.com/astrix-network/astrixd/infrastructure/network/netadapter/server"
...
type grpcStream interface {
	Send(*protowire.AstrixdMessage) error
	Recv() (*protowire.AstrixdMessage, error)
}
...
func (c *gRPCConnection) receive() (*protowire.AstrixdMessage, error) {
...
func (c *gRPCConnection) send(message *protowire.AstrixdMessage) error {
