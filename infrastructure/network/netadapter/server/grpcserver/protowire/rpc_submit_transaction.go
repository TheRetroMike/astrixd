...
func (x *AstrixdMessage_SubmitTransactionRequest) toAppMessage() (appmessage.Message, error) {
	if x == nil {
		return nil, errors.Wrapf(errorNil, "AstrixdMessage_SubmitTransactionRequest is nil")
	}
	return x.SubmitTransactionRequest.toAppMessage()
}

func (x *AstrixdMessage_SubmitTransactionRequest) fromAppMessage(message *appmessage.SubmitTransactionRequestMessage) error {
...
func (x *AstrixdMessage_SubmitTransactionResponse) toAppMessage() (appmessage.Message, error) {
	if x == nil {
		return nil, errors.Wrapf(errorNil, "AstrixdMessage_SubmitTransactionResponse is nil")
	}
	return x.SubmitTransactionResponse.toAppMessage()
}

func (x *AstrixdMessage_SubmitTransactionResponse) fromAppMessage(message *appmessage.SubmitTransactionResponseMessage) error {
	var err *RPCError
