...
type P2P_MessageStreamClient interface {
	Send(*AstrixdMessage) error
	Recv() (*AstrixdMessage, error)
	grpc.ClientStream
}
...
func (x *p2PMessageStreamClient) Send(m *AstrixdMessage) error {
	return x.ClientStream.SendMsg(m)
}

func (x *p2PMessageStreamClient) Recv() (*AstrixdMessage, error) {
	m := new(AstrixdMessage)
...
func (x *p2PMessageStreamServer) Send(m *AstrixdMessage) error {
	return x.ServerStream.SendMsg(m)
}

func (x *p2PMessageStreamServer) Recv() (*AstrixdMessage, error) {
	m := new(AstrixdMessage)
...
func (x *rPCMessageStreamClient) Send(m *AstrixdMessage) error {
	return x.ClientStream.SendMsg(m)
}

func (x *rPCMessageStreamClient) Recv() (*AstrixdMessage, error) {
	m := new(AstrixdMessage)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
func (x *rPCMessageStreamServer) Send(m *AstrixdMessage) error {
	return x.ServerStream.SendMsg(m)
}

func (x *rPCMessageStreamServer) Recv() (*AstrixdMessage, error) {
	m := new(AstrixdMessage)
	if err := x.ServerStream.RecvMsg(m); err != nil {
		return nil, err
	}
