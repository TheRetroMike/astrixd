...
func (x *AstrixdMessage_Version) toAppMessage() (appmessage.Message, error) {
	if x == nil {
		return nil, errors.Wrapf(errorNil, "AstrixdMessage_Version is nil")
	}
...
func (x *VersionMessage) toAppMessage() (appmessage.Message, error) {
	...
	//  Full astrix nodes set SubnetworkId==nil
	if err != nil && !errors.Is(err, errorNil) {
		return nil, err
	}
...
func (x *AstrixdMessage_Version) fromAppMessage(msgVersion *appmessage.MsgVersion) error {
