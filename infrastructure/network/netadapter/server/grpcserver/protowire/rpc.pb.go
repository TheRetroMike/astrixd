...
type GetBlockTemplateRequestMessage struct {
	...
	// Which astrix address should the coinbase block reward transaction pay into
...
type GetBlockTemplateResponseMessage struct {
	...
	// Whether astrixd thinks that it's synced.
	// Callers are discouraged (but not forbidden) from solving blocks when astrixd is not synced.
	// That is because when astrixd isn't in sync with the rest of the network there's a high
...
type GetConnectedPeerInfoMessage struct {
	...
	// Whether this astrixd initiated the connection
	...
	// The timestamp of when this peer connected to this astrixd
