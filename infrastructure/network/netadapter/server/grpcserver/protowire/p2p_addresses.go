...
func (x *AstrixdMessage_Addresses) toAppMessage() (appmessage.Message, error) {
	if x == nil {
		return nil, errors.Wrap(errorNil, "AstrixdMessage_Addresses is nil")
	}
...
func (x *AstrixdMessage_Addresses) fromAppMessage(msgAddresses *appmessage.MsgAddresses) error {
