...
func (x *AstrixdMessage_Transaction) toAppMessage() (appmessage.Message, error) {
	if x == nil {
		return nil, errors.Wrapf(errorNil, "AstrixdMessage_Transaction is nil")
	}
	return x.Transaction.toAppMessage()
}

func (x *AstrixdMessage_Transaction) fromAppMessage(msgTx *appmessage.MsgTx) error {
