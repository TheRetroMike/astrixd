...
func (x *AstrixdMessage_Block) toAppMessage() (appmessage.Message, error) {
	if x == nil {
		return nil, errors.Wrap(errorNil, "AstrixdMessage_Block is nil")
	}
	return x.Block.toAppMessage()
}

func (x *AstrixdMessage_Block) fromAppMessage(msgBlock *appmessage.MsgBlock) error {
