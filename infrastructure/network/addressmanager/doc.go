/*
Package addressmanager implements concurrency safe Astrix address manager.

# Address Manager Overview

In order maintain the peer-to-peer Astrix network, there needs to be a source
of addresses to connect to as nodes come and go. The Astrix protocol provides
