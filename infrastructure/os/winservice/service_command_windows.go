...
// installService attempts to install the astrixd service. Typically this should
...
// removeService attempts to uninstall the astrixd service. Typically this should
...
// startService attempts to Start the astrixd service.
