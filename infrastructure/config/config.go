...
const (
	defaultConfigFilename      = "astrixd.conf"
	defaultLogLevel            = "info"
	defaultLogDirname          = "logs"
	defaultLogFilename         = "astrixd.log"
	defaultErrLogFilename      = "astrixd_err.log"
	...
	sampleConfigFilename    = "sample-astrixd.conf"
...
var (
	...
	DefaultAppDir = util.AppDir("astrixd", false)
...
type Flags struct {
	...
	Listeners                       []string      `long:"listen" description:"Add an interface/port to listen for connections (default all interfaces port: 34151, testnet: 34251)"`
	...
	RPCListeners                    []string      `long:"rpclisten" description:"Add an interface/port to listen for RPC connections (default port: 34150, testnet: 34250)"`
	...
	MinRelayTxFee                   float64       `long:"minrelaytxfee" description:"The minimum transaction fee in AIX/kB to be considered a non-zero fee."`
...
//
// The above results in astrixd functioning properly without any config settings
...
// createDefaultConfig copies the file sample-astrixd.conf to the given destination path,
