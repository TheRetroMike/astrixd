...
A Block defines a astrix block that provides easier and more efficient
...
A Tx defines a astrix transaction that provides more efficient manipulation of
...
The Address interface provides an abstraction for a astrix address. While the
most common type is a pay-to-pubkey, astrix already supports others and
