...
var stringsToBech32Prefixes = map[string]Bech32Prefix{
	"astrix":     Bech32PrefixAstrix,
	"astrixdev":  Bech32PrefixAstrixDev,
	"astrixtest": Bech32PrefixAstrixTest,
	"astrixsim":  Bech32PrefixAstrixSim,
}
...
// and a payload which encodes the astrix network and address type. It is used
...
// with the passed astrix network.
