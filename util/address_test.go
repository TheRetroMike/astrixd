...
func TestAddresses(t *testing.T) {
	tests := []struct {
		...
		{
			name:    "mainnet p2pk",
			addr:    "astrix:qr35ennsep3hxfe7lnz5ee7j5jgmkjswsn35ennsep3hxfe7ln35cdv0dy335",
			encoded: "astrix:qr35ennsep3hxfe7lnz5ee7j5jgmkjswsn35ennsep3hxfe7ln35cdv0dy335",
			valid:   true,
			result: util.TstAddressPubKey(
				util.Bech32PrefixAstrix,
			...
			f: func() (util.Address, error) {
				publicKey := []byte{
					...
					0xe3, 0x4c, 0xce, 0x70, 0xc8, 0x63, 0x73, 0x27, 0x3e, 0xfc,
					0xe3, 0x4c}
				return util.NewAddressPublicKey(publicKey, util.Bech32PrefixAstrix)
			},
			passedPrefix:   util.Bech32PrefixUnknown,
			expectedPrefix: util.Bech32PrefixAstrix,
		},
		{
			name:    "mainnet p2pk 2",
			addr:    "astrix:qq80qvqs0lfxuzmt7sz3909ze6camq9d4t35ennsep3hxfe7ln35cvfqgz3z8",
			encoded: "astrix:qq80qvqs0lfxuzmt7sz3909ze6camq9d4t35ennsep3hxfe7ln35cvfqgz3z8",
			valid:   true,
			result: util.TstAddressPubKey(
				util.Bech32PrefixAstrix,
				[util.PublicKeySize]byte{
			...
			passedPrefix:   util.Bech32PrefixAstrix,
			expectedPrefix: util.Bech32PrefixAstrix,
		},
		{
			name:    "testnet p2pk",
			addr:    "astrixtest:qputx94qseratdmjs0j395mq8u03er0x3l35ennsep3hxfe7ln35ckquw528z",
			encoded: "astrixtest:qputx94qseratdmjs0j395mq8u03er0x3l35ennsep3hxfe7ln35ckquw528z",
			valid:   true,
			result: util.TstAddressPubKey(
				util.Bech32PrefixAstrixTest,
				[util.PublicKeySize]byte{
			...
			f: func() (util.Address, error) {
				...
				return util.NewAddressPublicKey(publicKey, util.Bech32PrefixAstrixTest)
			},
			passedPrefix:   util.Bech32PrefixAstrixTest,
			expectedPrefix: util.Bech32PrefixAstrixTest,
		},

		// ECDSA P2PK tests.
		{
			name:    "mainnet ecdsa p2pk",
			addr:    "astrix:qyp0r5mcq4rd5grj3652ra09u5dcgwqq9ntuswp247nama5quyj40eq03sc2dkx",
			encoded: "astrix:qyp0r5mcq4rd5grj3652ra09u5dcgwqq9ntuswp247nama5quyj40eq03sc2dkx",
			valid:   true,
			...
			f: func() (util.Address, error) {
				...
				return util.NewAddressPublicKeyECDSA(publicKey, util.Bech32PrefixAstrix)
			},
			passedPrefix:   util.Bech32PrefixUnknown,
			expectedPrefix: util.Bech32PrefixAstrix,
		},
		...
		},
		{
			...
			addr:           "astrix:qr35ennsep3hxfe7lnz5ee7j5jgmkjswss74as46gx",
			valid:          false,
			passedPrefix:   util.Bech32PrefixAstrix,
			expectedPrefix: util.Bech32PrefixAstrix,
		},
		...
		{
			name:    "mainnet p2sh",
			addr:    "astrix:prq20q4qd9ulr044cauyy9wtpeupqpjv67pn2vyc6acly7xqkrjdzmh8rj9f4",
			encoded: "astrix:prq20q4qd9ulr044cauyy9wtpeupqpjv67pn2vyc6acly7xqkrjdzmh8rj9f4",
			valid:   true,
			...
			f: func() (util.Address, error) {
				script := []byte{
					...
					0xae}
				return util.NewAddressScriptHash(script, util.Bech32PrefixAstrix)
			},
			passedPrefix:   util.Bech32PrefixAstrix,
			expectedPrefix: util.Bech32PrefixAstrix,
		},
		{
			name:    "mainnet p2sh 2",
			addr:    "astrix:pr5vxqxg0xrwl2zvxlq9rxffqx00sm44kn5vxqxg0xrwl2zvxl5vxyhvsake2",
			encoded: "astrix:pr5vxqxg0xrwl2zvxlq9rxffqx00sm44kn5vxqxg0xrwl2zvxl5vxyhvsake2",
			valid:   true,
			result: util.TstAddressScriptHash(
				util.Bech32PrefixAstrix,
				[blake2b.Size256]byte{
			...
			f: func() (util.Address, error) {
				...
				return util.NewAddressScriptHashFromHash(hash, util.Bech32PrefixAstrix)
			},
			passedPrefix:   util.Bech32PrefixAstrix,
			expectedPrefix: util.Bech32PrefixAstrix,
		},
		{
			name:    "testnet p2sh",
			addr:    "astrixtest:przhjdpv93xfygpqtckdc2zkzuzqeyj2pt5vxqxg0xrwl2zvxl5vx35yyy2h9",
			encoded: "astrixtest:przhjdpv93xfygpqtckdc2zkzuzqeyj2pt5vxqxg0xrwl2zvxl5vx35yyy2h9",
			valid:   true,
			result: util.TstAddressScriptHash(
				util.Bech32PrefixAstrixTest,
				[blake2b.Size256]byte{
			...
			f: func() (util.Address, error) {
				...
				return util.NewAddressScriptHashFromHash(hash, util.Bech32PrefixAstrixTest)
			},
			passedPrefix:   util.Bech32PrefixAstrixTest,
			expectedPrefix: util.Bech32PrefixAstrixTest,
		},
...
func TestDecodeAddressErrorConditions(t *testing.T) {
	tests := []struct {
		...
		{
			"astrixsim:raskzctpv9skzctpv9skzctpv9skzctpvy37ct7zafpv9skzctpvymmnd3gh8",
			util.Bech32PrefixAstrixSim,
			"unknown address type",
		},
		{
			"astrixsim:raskzcg58mth0an",
			util.Bech32PrefixAstrixSim,
			"unknown address type",
		},
		{
			"astrixtest:qqq65mvpxcmajeq44n2n8vfn6u9f8l4zsy0xez0tzw",
			util.Bech32PrefixAstrix,
...
func TestParsePrefix(t *testing.T) {
	tests := []struct {
		...
		{"astrix", util.Bech32PrefixAstrix, false},
		{"astrixtest", util.Bech32PrefixAstrixTest, false},
		{"astrixsim", util.Bech32PrefixAstrixSim, false},
...
func TestPrefixToString(t *testing.T) {
	tests := []struct {
		...
		{util.Bech32PrefixAstrix, "astrix"},
		{util.Bech32PrefixAstrixTest, "astrixtest"},
		{util.Bech32PrefixAstrixSim, "astrixsim"},
		{util.Bech32PrefixUnknown, ""},
	}
