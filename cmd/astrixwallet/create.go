...
import (
	...
	"github.com/astrix-network/astrixd/cmd/astrixwallet/libastrixwallet/bip32"
...
func create(conf *createConfig) error {
	...
	fmt.Printf("Notice the above is neither a secret key to your wallet " +
		"(use \"astrixwallet dump-unencrypted-data\" to see a secret seed phrase) " +
		"nor a wallet public address (use \"astrixwallet new-address\" to create and see one)\n\n")
	...
	if len(signerExtendedPublicKeys) > 0 {
		cosignerIndex, err = libastrixwallet.MinimumCosignerIndex(signerExtendedPublicKeys, extendedPublicKeys)
		if err != nil {
			return err
		}
	}
