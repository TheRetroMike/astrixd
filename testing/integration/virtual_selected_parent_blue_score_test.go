...
func TestVirtualSelectedParentBlueScoreAndVirtualDAAScore(t *testing.T) {
	...
	response, err := astrixd.rpcClient.GetVirtualSelectedParentBlueScore()
	if err != nil {
	...
	err = astrixd.rpcClient.RegisterForVirtualSelectedParentBlueScoreChangedNotifications(
	...
	err = astrixd.rpcClient.RegisterForVirtualDaaScoreChangedNotifications(
