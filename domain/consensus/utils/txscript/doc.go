/*
Package txscript implements the astrix transaction script language.

This package provides data structures and functions to parse and execute
astrix transaction scripts.

# Script Overview

Astrix transaction scripts are written in a stack-base, FORTH-like language.

The astrix script language consists of a number of opcodes which fall into
...
Typical astrix scripts at the time of this writing are of several standard
...
what conditions must be met in order to spend astrix.
