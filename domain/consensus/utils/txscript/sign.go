...
// SignatureScript creates an input signature script for tx to spend AIX sent
...
// SignatureScriptECDSA creates an input signature script for tx to spend AIX sent
