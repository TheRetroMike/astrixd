...
import (
	...
	"github.com/astrix-network/astrixd/domain/consensus/utils/multiset"
	"github.com/astrix-network/astrixd/domain/consensus/utils/utxo"
	"github.com/astrix-network/astrixd/domain/consensus/utils/virtual"
...
// This is a sanity test, to make sure that astrixd doesn't store, and subsequently sends syncing peers the wrong UTXOSet.
...
func (pm *pruningManager) TrustedBlocAIXsociatedGHOSTDAGDataBlockHashes(stagingArea *model.StagingArea, blockHash *externalapi.DomainHash) ([]*externalapi.DomainHash, error) {
