...
func (v *transactionValidator) checkTransactionAmountRanges(tx *externalapi.DomainTransaction) error {
	...
	// as a sompi. One astrix is a quantity of sompi as defined by the
	// sompiPerAstrix constant.
	...
	for _, txOut := range tx.Outputs {
		...
		// This is impossible for Astrix, but perhaps possible if an alt increases
