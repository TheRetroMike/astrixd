...
import (
	...
	"github.com/astrix-network/astrixd/util/network"
...
// Params defines a Astrix network by its parameters. These parameters may be
// used by Astrix applications to differentiate networks as well as addresses
...
type Params struct {
	...
	// Further details: https://hashdag.medium.com/astrix-launch-plan-9a63f4d754a6
	...
	// PruningProofM is the 'm' constant in the pruning proof. For more details see: https://github.com/astrix-network/research/issues/3
...
// MainnetParams defines the network parameters for the main Astrix network.
var MainnetParams = Params{
	...
	DNSSeeds: []string{
		...
		"dnsseeder1.astrix-network.com",
		"dnsseeder2.astrix-network.com",
	...
	Prefix: util.Bech32PrefixAstrix,
...
// TestnetParams defines the network parameters for the test Astrix network.
var TestnetParams = Params{
	...
	// Human-readable part for Bech32 encoded addresses
	Prefix: util.Bech32PrefixAstrixTest,
...
// SimnetParams defines the network parameters for the simulation test Astrix
...
var SimnetParams = Params{
	...
	// Human-readable part for Bech32 encoded addresses
	Prefix: util.Bech32PrefixAstrixSim,
...
// DevnetParams defines the network parameters for the development Astrix network.
var DevnetParams = Params{
	...
	// Human-readable part for Bech32 encoded addresses
	Prefix: util.Bech32PrefixAstrixDev,
...
// ErrDuplicateNet describes an error where the parameters for a Astrix
// network could not be set due to the network already being a standard
// network or previously-registered into this package.
var ErrDuplicateNet = errors.New("duplicate Astrix network")

var registeredNets = make(map[appmessage.AstrixNet]struct{})

// Register registers the network parameters for a Astrix network. This may
