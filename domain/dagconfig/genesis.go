...
import (
	...
	"github.com/astrix-network/astrixd/domain/consensus/utils/blockheader"
	"github.com/astrix-network/astrixd/domain/consensus/utils/subnetworks"
	"github.com/astrix-network/astrixd/domain/consensus/utils/transactionhelper"
	"math/big"
)
...
var genesisTxPayload = []byte{
	...
	0x01,                                           // Varint
	0x00,                                           // OP-FALSE
	0x00, 0x0b, 0x3b, 0x8e, 0x2f, 0x19, 0xb4, 0x13,
	0x3d, 0x43, 0x91, 0x74, 0xe5, 0x2e, 0xfb, 0xb0,
	0x14, 0x1c, 0x35, 0x83, 0xa8, 0xaa, 0x66, 0xb0,
	0x0f, 0xca, 0x37, 0xca, 0x62, 0x7c, 0x2d, 0x58,
}
...
var genesisHash = externalapi.NewDomainHashFromByteArray(&[externalapi.DomainHashSize]byte{
	0xf0, 0x5c, 0xf1, 0x44, 0xaf, 0x06, 0x7b, 0x20, 0xcf, 0xae, 0x86, 0xb8, 0x97, 0x6d, 0xce, 0x34, 0xfa, 0xc7, 0x2c, 0x41, 0x7c, 0xcb, 0xdb, 0xd6, 0x56, 0x39, 0x66, 0x37, 0x22, 0xb3, 0x06, 0xf3,
})

// genesisMerkleRoot is the hash of the first transaction in the genesis block
// for the main network.
var genesisMerkleRoot = externalapi.NewDomainHashFromByteArray(&[externalapi.DomainHashSize]byte{
	0xfc, 0xe2, 0x3f, 0xe1, 0x8f, 0x13, 0xd3, 0x50, 0xbc, 0x6a, 0x75, 0x44, 0xff, 0xd7, 0x86, 0xd1, 0x50, 0x02, 0x94, 0x83, 0x4d, 0x94, 0x66, 0x6c,0x4c, 0xa8, 0x89, 0x13, 0x60, 0xbc, 0x2e, 0x53,
})
...
var devnetGenesisTxPayload = []byte{
	...
	0x01,                                                                   // Varint
	0x00,                                                                   // OP-FALSE
	0x6b, 0x61, 0x73, 0x70, 0x61, 0x2d, 0x64, 0x65, 0x76, 0x6e, 0x65, 0x74, // astrix-devnet
}
...
var simnetGenesisTxPayload = []byte{
	...
	0x01,                                                                   // Varint
	0x00,                                                                   // OP-FALSE
	0x6b, 0x61, 0x73, 0x70, 0x61, 0x2d, 0x73, 0x69, 0x6d, 0x6e, 0x65, 0x74, // astrix-simnet
}
...
var testnetGenesisTxPayload = []byte{
	...
	0x01,                                                                         // Varint
	0x00,                                                                         // OP-FALSE
	0x6b, 0x61, 0x73, 0x70, 0x61, 0x2d, 0x74, 0x65, 0x73, 0x74, 0x6e, 0x65, 0x74, // astrix-testnet
}
