...
import (
	...
	"github.com/astrix-network/astrixd/domain/consensusreference"
	"github.com/astrix-network/astrixd/domain/miningmanager/model"
	...
	"github.com/astrix-network/astrixd/domain/miningmanager"
...
func generateNewCoinbase(addressPrefix util.Bech32Prefix, op opType) (*externalapi.DomainCoinbaseData, error) {
	...
	_, publicKey, err := libastrixwallet.CreateKeyPair(op == opECDSA)
	if err != nil {
		return nil, err
	}
	var address string
