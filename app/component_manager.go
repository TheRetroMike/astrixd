...
import (
	...
	"github.com/astrix-network/astrixd/app/protocol"
	"github.com/astrix-network/astrixd/app/rpc"
	"github.com/astrix-network/astrixd/domain"
	"github.com/astrix-network/astrixd/domain/consensus"
	"github.com/astrix-network/astrixd/domain/utxoindex"
	...
	"github.com/astrix-network/astrixd/infrastructure/network/connmanager"
	"github.com/astrix-network/astrixd/infrastructure/network/netadapter"
	"github.com/astrix-network/astrixd/infrastructure/network/netadapter/id"
	"github.com/astrix-network/astrixd/util/panics"
)

// ComponentManager is a wrapper for all the astrixd services
...
// Start launches all the astrixd services.
...
// Stop gracefully shuts down all the astrixd services.
func (a *ComponentManager) Stop() {
	// Make sure this only happens once.
	if atomic.AddInt32(&a.shutdown, 1) != 1 {
		log.Infof("Astrixd is already in the process of shutting down")
		return
	}

	log.Warnf("Astrixd shutting down")
