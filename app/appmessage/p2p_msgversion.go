...
var DefaultUserAgent = fmt.Sprintf("/astrixd:%s/", version.Version())

// MsgVersion implements the Message interface and represents a astrix version
...
// NewMsgVersion returns a new astrix version message that conforms to the
