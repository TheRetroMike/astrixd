...
// MsgRequestHeaders implements the Message interface and represents a astrix
...
// NewMsgRequstHeaders returns a new astrix RequestHeaders message that conforms to the
