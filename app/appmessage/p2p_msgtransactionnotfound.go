...
// MsgTransactionNotFound defines a astrix TransactionNotFound message which is sent in response to
...
// NewMsgTransactionNotFound returns a new astrix transactionsnotfound message that conforms to the
