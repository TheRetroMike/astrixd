...
// MsgRequestAddresses implements the Message interface and represents a astrix
...
// NewMsgRequestAddresses returns a new astrix RequestAddresses message that conforms to the
