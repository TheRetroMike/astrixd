...
// MsgRequestAnticone implements the Message interface and represents a astrix
...
// NewMsgRequestAnticone returns a new astrix RequestPastDiff message that conforms to the
