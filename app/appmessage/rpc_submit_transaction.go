...
// RPCTransaction is a astrixd transaction representation meant to be
// used over RPC
...
// RPCTransactionInput is a astrixd transaction input representation
...
// RPCScriptPublicKey is a astrixd ScriptPublicKey representation
type RPCScriptPublicKey struct {
	Version uint16
	Script  string
}

// RPCTransactionOutput is a astrixd transaction output representation
// meant to be used over RPC
...
// RPCOutpoint is a astrixd outpoint representation meant to be used
// over RPC
...
// RPCUTXOEntry is a astrixd utxo entry representation meant to be used
// over RPC
