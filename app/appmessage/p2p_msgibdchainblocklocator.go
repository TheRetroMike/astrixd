...
// MsgIBDChainBlockLocator implements the Message interface and represents a astrix
...
// NewMsgIBDChainBlockLocator returns a new astrix locator message that conforms to
