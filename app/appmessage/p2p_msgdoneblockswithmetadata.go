...
// MsgDoneBlocksWithTrustedData implements the Message interface and represents a astrix
...
// NewMsgDoneBlocksWithTrustedData returns a new astrix DoneBlocksWithTrustedData message that conforms to the
// Message interface.
