...
// MsgRequestTransactions implements the Message interface and represents a astrix
...
// NewMsgRequestTransactions returns a new astrix RequestTransactions message that conforms to
