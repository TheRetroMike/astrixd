...
// MsgDoneHeaders implements the Message interface and represents a astrix
...
// NewMsgDoneHeaders returns a new astrix DoneIBDBlocks message that conforms to the
// Message interface.
