...
// MsgRequestNextPruningPointAndItsAnticoneBlocks implements the Message interface and represents a astrix
...
// NewMsgRequestNextPruningPointAndItsAnticoneBlocks returns a new astrix RequestNextPruningPointAndItsAnticoneBlocks message that conforms to the
// Message interface.
