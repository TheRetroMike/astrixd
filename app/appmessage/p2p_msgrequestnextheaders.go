...
// MsgRequestNextHeaders implements the Message interface and represents a astrix
...
// NewMsgRequestNextHeaders returns a new astrix RequestNextHeaders message that conforms to the
// Message interface.
