...
// MsgRequestRelayBlocks implements the Message interface and represents a astrix
...
// NewMsgRequestRelayBlocks returns a new astrix RequestRelayBlocks message that conforms to
