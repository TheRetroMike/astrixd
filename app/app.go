...
import (
	...
	"github.com/astrix-network/astrixd/infrastructure/os/execenv"
	"github.com/astrix-network/astrixd/infrastructure/os/limits"
	"github.com/astrix-network/astrixd/infrastructure/os/signal"
	"github.com/astrix-network/astrixd/infrastructure/os/winservice"
...
var serviceDescription = &winservice.ServiceDescription{
	Name:        "astrixdsvc",
	DisplayName: "Astrixd Service",
	Description: "Downloads and stays synchronized with the Astrix blockDAG and " +
		"provides DAG services to applications.",
}

type astrixdApp struct {
	cfg *config.Config
}

// StartApp starts the astrixd app, and blocks until it finishes running
func StartApp() error {
...
func (app *astrixdApp) main(startedChan chan<- struct{}) error {
	...
	if err != nil {
		log.Errorf("Unable to start astrixd: %+v", err)
		return err
	}

	defer func() {
		log.Infof("Gracefully shutting down astrixd...")
		...
		log.Infof("Astrixd shutdown complete")
	}()
